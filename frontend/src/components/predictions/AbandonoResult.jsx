...
function getRiskBand(probability) {
  if (probability >= 0.7) {
    return {
      ...
      title: "RIESGO ALTO DE ABANDONO",
      subtitle: "El modelo detecta señales fuertes de riesgo de abandono académico.",
      icon: "alert",
    };
  }
  if (probability >= 0.4) {
    return {
      ...
      title: "RIESGO MODERADO DE ABANDONO",
      subtitle: "El modelo detecta algunas señales de riesgo. Se recomienda seguimiento.",
      icon: "warning",
    };
  }
  return {
    ...
    title: "RIESGO BAJO DE ABANDONO",
    subtitle: "El modelo no detecta señales de abandono relevantes para este alumno.",
    icon: "check",
  };
}
