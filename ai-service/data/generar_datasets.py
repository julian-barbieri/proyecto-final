    ...
    for alumno_id, datos_alumno in estudiantes.items():
        ...
        for anio in range(datos_alumno["anio_ingreso"], max_anio + 1):
            ...
            for mat_code in materias:
                ...
                asistencia_final = round(generar_asistencia_tipo(datos_alumno["tipo_alumno"]), 2)
        ...
        notas_finales_por_alumno[alumno_id] = dict(notas_finales)
        aprobadas_por_alumno[alumno_id] = len(aprobadas)
