...
# Lee los datasets desde la carpeta actual
df_examen = pd.read_csv('nivel_examen.csv')
df_materia = pd.read_csv('nivel_materia.csv')
df_alumno = pd.read_csv('nivel_alumno.csv')
